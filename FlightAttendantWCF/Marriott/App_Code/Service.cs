...
public class Service : IService
{
    private IList<Room> rooms = new List<Room>()
    {
            ...
            new Room { City = "DXB", RoomNr = 506, Checkin = "2020-3-12", Checkout = "2020-3-28"},
            new Room { City = "DXB", RoomNr = 410, Checkin = "2020-3-6", Checkout = "2020-3-20"},
            new Room { City = "DXB", RoomNr = 404, Checkin = "2020-3-18", Checkout = "2020-3-19"},
            ...
            new Room { City = "SIN", RoomNr = 305, Checkin = "2020-3-2", Checkout = "2020-3-26"},
            new Room { City = "SIN", RoomNr = 306, Checkin = "2020-3-5", Checkout = "2020-3-28"},            
